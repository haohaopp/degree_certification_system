    ...
    <table class="layui-table">
        ...
        <c:forEach items="${degreesList}" var="v">
            <tr>
                ...
                <td>${v.status}</td>
                <td>
                    <a href="DegreesServlet?type=edit&id=${v.degree_id}" class="layui-btn layui-btn layui-btn-sm">修改</a>
                    <a href="DegreesServlet?type=delete&id=${v.degree_id}" class="layui-btn layui-btn-danger layui-btn-sm">删除</a>
