...
public class DegreesObject implements Serializable {
    public long id;
    public String name;
    public String times;
    public String data;
    public Degrees result;

    public DegreesObject() {
    }
    ...
    public Degrees getResult() {
        return result;
    }

    public void setResult(Degrees result) {
        this.result = result;
    }
