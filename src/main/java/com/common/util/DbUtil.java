...
public class DbUtil {
    ...
    static String url = "jdbc:mysql://localhost:3306/2522?useUnicode=true&characterEncoding=UTF8&useInformationSchema=true&remarks=true";
    ...
    public static List<Map<String, String>> queryListMap(String sql) {
        ...
        try {
            ...
            e.printStackTrace();
            System.out.println(com.common.util.DbUtil.class.getName() + "查询失败" + e.getMessage());
        }
        return mapList;
    }
