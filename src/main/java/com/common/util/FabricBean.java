...
public final class FabricBean {
    ...
    public static String  dataFlag="zcode_zcode_v6";

    private static class ConnFabric {
        private ManagedChannel grpcChannel;
        private Gateway.Builder builder;
        private FabricBean aa;
    ...
    public static void submitData(String flag, String data) {
        ...
        try {
            ...
            FabricBean aa = connFabric.getAa();
    ...
    public static List<DegreesObject> queryData(String flag) {
        List<DegreesObject> dataList = new ArrayList<DegreesObject>();
        try {
    ...
    public List<DegreesObject> run(Contract contract, String flag) throws GatewayException, CommitException {
        ...
        for (Object obj : objects) {
            ...
            if (ID.startsWith(flag)) {
                DegreesObject bean = JSON.parseObject(Owner, DegreesObject.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<DegreesObject> dataList = queryData("vote");
